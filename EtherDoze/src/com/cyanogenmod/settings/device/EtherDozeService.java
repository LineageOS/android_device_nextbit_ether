...
public class EtherDozeService extends Service {
    private static final String TAG = "EtherDozeService";
    ...
    private EtherProximitySensor mSensor;
    ...
    class EtherProximitySensor implements SensorEventListener {
        ...
        public EtherProximitySensor(Context context) {
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "EtherDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new EtherProximitySensor(mContext);
