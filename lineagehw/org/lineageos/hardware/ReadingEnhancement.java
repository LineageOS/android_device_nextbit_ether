...
public class ReadingEnhancement {
    ...
    /**
     * Whether device supports a reading mode
     *
     * @return boolean Supported devices must return always true
     */
    public static boolean isSupported() {
        return FileUtils.isFileWritable(FILE_READING);
    }


    /**
     * This method returns the current activation status of the reading mode
     *
     * @return boolean Must be false when reading mode is not supported or not activated, or
    ...
    /**
     * This method allows to setup the reading mode
     *
     * @param status The new reading mode status
